...
public class Reflection_01 implements Serializable {
    ...
    private Reflection_01(String name, String webAddress, String email) {
        this.setName(name);
    ...
    protected Reflection_01(String name, String webAddress, String email, int zip) {
        this.setName(name);
        this.setWebAddress(webAddress);
        this.setEmail(email);
        this.setZip(2300);
