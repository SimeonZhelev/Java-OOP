...
public class Main {
    public static void main(String[] args) {
        ...
        Map<String, VehicleImpl> vehicleMap = Map.of("Exercise05_Polymorphism.VehicleExtension_02.Car", car,
                "Exercise05_Polymorphism.VehicleExtension_02.Truck", truck,
                "Exercise05_Polymorphism.VehicleExtension_02.Bus", bus);
